...
function calculVolume(volumeValue, dot, pageX) {
...
function updateVolume1(e) {
    const dot1 = document.getElementById("dot1");
    const volumeValue1 = document.getElementById("volumeValue1");
    state.volume.general = calculVolume(volumeValue1, dot1, e.pageX);
}
function updateVolume2(e) {
    const dot2 = document.getElementById("dot2");
    const volumeValue2 = document.getElementById("volumeValue2");
    state.volume.noises = calculVolume(volumeValue2, dot2, e.pageX);
}
function updateVolume3(e) {
    const dot3 = document.getElementById("dot3");
    const volumeValue3 = document.getElementById("volumeValue3");
    state.volume.music = calculVolume(volumeValue3, dot3, e.pageX);
}
function initVolume() {
    const dot1 = document.getElementById("dot1");
    const dot2 = document.getElementById("dot2");
