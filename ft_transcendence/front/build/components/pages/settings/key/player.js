...
export function player() {
    ...
    state.events = new Map([
        ...
        [keyName1, { type: "mouseover", callback: changeKey1 }],
        [keyName2, { type: "mouseover", callback: changeKey2 }]
    ]);
    closeEvent();
}
function initPlayer() {
