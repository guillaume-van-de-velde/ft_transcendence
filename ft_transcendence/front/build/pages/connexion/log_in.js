    ...
    <div class="app bg-home-bg text-white h-screen justify-center items-center font-dangrek flex flex-col">
        <div class="felx flex-col h-2/3 w-full justify-around items-center mx-auto">
            ...
            <p class="opacity-100 cursor-pointer hover:tracking-[5px] duration-300">
                CONNEXION<p class="whitespace-pre opacity-50"> > LOG IN</p>
            </p>
            </span>
            <form action="" class="grid grid-rows-2 relative -translate-x-30 justify-around items-center h-1/2 mt-20">
