    ...
    return `
        ...
        <form action="" class="h-1/2 grid grid-rows-3 w-[80%] mt-10 relative">
            <div class="grid grid-cols-[1fr_2fr] items-center justify-center w-full">
                ...
                <label for="yourpassword" class="text-4xl text-center inline-block mx-auto cursor-pointer hover:tracking-widest duration-300">YOUR PASSWORD : </label>            </div>
                <input type="text" name="yourpassword" id="yourpassword" class="bg-form-bg text-white text-5xl w-[100%] rounded-2xl text-center">
            </div>
            <div class="grid grid-cols-[1fr_2fr] items-center justify-center w-full">
                <div class="flex justify-center">
                    <label for="newpassword" class="text-4xl text-center inline-block mx-auto cursor-pointer hover:tracking-widest duration-300">NEW PASSWORD : </label>
                </div>
            ...
            <button type="submit" class="absolute h-[75px] w-[75px] rounded-full bg-button-white-bg bottom-1/2 translate-y-1/2 right-0 translate-x-40 text-black text-3xl hover:h-[80px] hover:w-[80px] duration-300 cursor-pointer">
