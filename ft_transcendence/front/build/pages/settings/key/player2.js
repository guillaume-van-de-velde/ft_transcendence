export function player2_HTML() {
    ...
    <div class="action">
        ...
        <span class="text-3xl flex justify-center items-center tracking-widest">
            <p>
                <p id="key" class="opacity-100 cursor-pointer hover:tracking-[5px] duration-300">KEY</p><p class="whitespace-pre opacity-50"> > PLAYER 2</p>
            </p>
        </span>
        <div class="flex flex-col justify-around items-center h-1/2 [&_h2]:text-5xl mt-10">
            <div class="flex justify-around items-center w-[60%] h-1/2">
                ...
                <div class="w-1/2 h-full flex justify-center items-center">
                    <button class="h-[75px] w-[75px] bg-button-white-bg text-black rounded-full hover:h-[90px] hover:w-[90px] duration-300 cursor-pointer">
                        <i class="fa-solid fa-arrow-up text-4xl"></i>
                    </button>
                </div>
            </div>
            <div class="flex justify-around items-center w-[60%] h-1/2">
