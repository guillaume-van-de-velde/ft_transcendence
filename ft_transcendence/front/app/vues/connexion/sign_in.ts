        ...
        <form id="formSignIn" action="" class="h-1/2 grid grid-rows-4 w-[60%] mt-20 relative -translate-x-30">
            <div class="grid grid-cols-[1fr_2fr] items-center justify-center w-full h-1/4">
                <div class="flex justify-center">
                    <label for="email" class="text-4xl text-center inline-block mx-auto cursor-pointer hover:tracking-widest duration-300">${i18next.t("email")} : </label>
                </div>
            ...
            <div class="grid grid-cols-[1fr_2fr] items-center justify-center w-full h-1/4">
                <div class="flex justify-center">
                    <label for="pseudo" class="text-4xl text-center inline-block mx-auto cursor-pointer hover:tracking-widest duration-300">${i18next.t("pseudo")} : </label>
                </div>
